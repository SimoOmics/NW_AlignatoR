...
# input here your strings to align
# can use the provided sequences files 
# or the random strings to test

str1<- "GTAGCCTACAATGGGCATTAAAAA"
#str1 <- as.character(read.table('3_LCO.unclipped.seq'))

str2<- "CACGAATTCCCCATCGGGGTTCTCTC"
#str2 <- as.character(read.table('6_LCO.unclipped.seq'))
